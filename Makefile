...
HTTPS_GIT := https://github.com/GPTx-global/guru.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=guru \
          -X github.com/cosmos/cosmos-sdk/version.AppName=$(GURU_BINARY) \
...
build-docker:
	...
	$(DOCKER) create --name guru -t -i ${DOCKER_IMAGE}:latest guru
	# move the binaries to the ./build directory
	mkdir -p ./build/
	$(DOCKER) cp guru:/usr/bin/gurud ./build/
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/guru/guru"
	godoc -http=:6060
...
PACKAGE_NAME:=github.com/guru/guru
