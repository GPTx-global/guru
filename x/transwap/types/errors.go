...
var (
	...
	ErrInvalidCexId            = sdkerrors.Register(ModuleName, 10, "invalid cex id")
	ErrInvalidRate             = sdkerrors.Register(ModuleName, 11, "invalid rate")
	ErrInvalidSlippage         = sdkerrors.Register(ModuleName, 12, "invalid slippage")
)
