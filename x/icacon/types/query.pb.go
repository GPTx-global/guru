...
// source: guru/icacon/query.proto
...
func (*QueryInterchainAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_758b522062fcbc97, []int{0}
}
...
func (*QueryInterchainAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_758b522062fcbc97, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryInterchainAccountRequest)(nil), "icacon.QueryInterchainAccountRequest")
	proto.RegisterType((*QueryInterchainAccountResponse)(nil), "icacon.QueryInterchainAccountResponse")
}

func init() { proto.RegisterFile("guru/icacon/query.proto", fileDescriptor_758b522062fcbc97) }

var fileDescriptor_758b522062fcbc97 = []byte{
	// 365 bytes of a gzipped FileDescriptorProto
	,
	...
	0x9c, 0x9f, 0xab, 0xef, 0x1e, 0x10, 0x52, 0xa1, 0x9b, 0x9e, 0x93, 0x9f, 0x94, 0x98, 0xa3, 0x0f,
	0x4e, 0x3f, 0x15, 0x30, 0xbb, 0x4b, 0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xc9, 0xc0, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0xf4, 0x8e, 0x96, 0x1d, 0x5d, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) InterchainAccount(ctx context.Context, in *QueryInterchainAccountRequest, opts ...grpc.CallOption) (*QueryInterchainAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/icacon.Query/InterchainAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InterchainAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/icacon.Query/InterchainAccount",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "guru/icacon/query.proto",
}
