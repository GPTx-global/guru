...
func NewGenesisState(params Params, docs []OracleRequestDoc, moderatorAddress string, oracleRequestDocCount uint64, predefinedOracles []PredefinedOracle) GenesisState {
	return GenesisState{
		Params:                params,
