...
import (
	...
	"github.com/GPTx-global/guru/x/oracle/client/cli"
...
// RegisterInvariants registers the cex module invariants.
...
// Route returns the message routing key for the cex module.
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, am.NewHandler())
}

// QuerierRoute returns the cex module's querier route name.
func (AppModule) QuerierRoute() string {
	return types.RouterKey
}

// LegacyQuerierHandler returns the cex module sdk.Querier.
...
// InitGenesis performs genesis initialization for the cex module. It returns
...
// ExportGenesis returns the exported genesis state as raw bytes for the cex module.
...
// RandomizedParams creates randomized cex param changes for the simulator.
func (AppModule) RandomizedParams(r *rand.Rand) []simtypes.ParamChange {
	return []simtypes.ParamChange{}
}

// RegisterStoreDecoder registers a decoder for cex module's types.
