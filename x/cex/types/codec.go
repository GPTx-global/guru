...
var (
	...
	// ModuleCdc references the global xmsquare module codec. Note, the codec should
	// ONLY be used in certain instances of tests and for JSON encoding.
	//
	// The actual codec used for serialization should be provided to modules/xmsquare and
...
// RegisterLegacyAminoCodec registers the necessary x/cex interfaces and concrete types
