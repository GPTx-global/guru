...
type V4ChainConfig struct {
	...
	ShanghaiTime *github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,22,opt,name=shanghai_block,json=ShanghaiTime,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"shanghai_block,omitempty" yaml:"shanghai_block"`
	// cancun_block switch block (nil = no fork, 0 = already on cancun)
	CancunTime *github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,23,opt,name=cancun_block,json=CancunTime,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"cancun_block,omitempty" yaml:"cancun_block"`
}
