...
import (
	...
	evmkeeper "github.com/GPTx-global/guru/x/evm/keeper"
	evmtypes "github.com/GPTx-global/guru/x/evm/types"
	"github.com/GPTx-global/guru/x/feemarket"
	feemarketkeeper "github.com/GPTx-global/guru/x/feemarket/keeper"
	feemarkettypes "github.com/GPTx-global/guru/x/feemarket/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/GPTx-global/guru/client/docs/statik"

	"github.com/GPTx-global/guru/app/ante"

	"github.com/GPTx-global/guru/x/epochs"
	epochskeeper "github.com/GPTx-global/guru/x/epochs/keeper"
	epochstypes "github.com/GPTx-global/guru/x/epochs/types"
	"github.com/GPTx-global/guru/x/erc20"
	erc20client "github.com/GPTx-global/guru/x/erc20/client"
	erc20keeper "github.com/GPTx-global/guru/x/erc20/keeper"
	erc20types "github.com/GPTx-global/guru/x/erc20/types"
	"github.com/GPTx-global/guru/x/inflation"
	...
	"github.com/GPTx-global/guru/x/vesting"
	...
	// guru defined modules
	icacon "github.com/GPTx-global/guru/x/icacon"
	icaconkeeper "github.com/GPTx-global/guru/x/icacon/keeper"
	icacontypes "github.com/GPTx-global/guru/x/icacon/types"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".gurud")
...
var (
	_ servertypes.Application = (*Guru)(nil)
	_ ibctesting.TestingApp   = (*Guru)(nil)
)

// Guru implements an extended ABCI application. It is an application
...
type Guru struct {
	*baseapp.BaseApp
	...
	ICAConKeeper        icaconkeeper.Keeper
	...
	ScopedICAConKeeper        capabilitykeeper.ScopedKeeper
...
func NewEvmos(
	...
	scopedICAConKeeper := app.CapabilityKeeper.ScopeToModule(icacontypes.ModuleName)
	...
	*/
	...
	app.ICAConKeeper = icaconkeeper.NewKeeper(appCodec, keys[icacontypes.StoreKey], app.ICAControllerKeeper, scopedICAConKeeper)
	icaconModule := icacon.NewAppModule(appCodec, app.ICAConKeeper)
	icaconIBCModule := icacon.NewIBCModule(app.ICAConKeeper)

	icaControllerIBCModule := icacontroller.NewIBCMiddleware(icaconIBCModule, app.ICAControllerKeeper)
	...
	*/
	...
	ibcRouter.
		...
		AddRoute(icacontypes.ModuleName, icaControllerStack).
	...
	app.ScopedICAConKeeper = scopedICAConKeeper
...
func (app *Guru) Name() string { return app.BaseApp.Name() }

func (app *Guru) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *Guru) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// The DeliverTx method is intentionally decomposed to calculate the transactions per second.
func (app *Guru) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Guru) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Guru) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Guru) ModuleAccountAddrs() map[string]bool {
...
func (app *Guru) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Guru's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Guru) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Guru's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Guru) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Guru's InterfaceRegistry
func (app *Guru) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Guru) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Guru) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Guru) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Guru) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *Guru) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Guru) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *Guru) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Guru) RegisterNodeService(clientCtx client.Context) {
...
func (app *Guru) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Guru) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *Guru) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Guru) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Guru) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Guru) GetTxConfig() client.TxConfig {
