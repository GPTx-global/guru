...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "guru_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "GURU_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Guru_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "guru_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "guru_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "guru_guru_3110-1", true, nil,
		},
		{
			"invalid epoch, undefined", "guru_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "guru_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
